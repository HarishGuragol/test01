...
document.querySelector('#btn').addEventListener('click', () => {
  ...
  let Awesome = {
    name: 'Awesome Designed Chair',
    value: 5430.00,
    amount: totalItems,
    src: 'assets/img/awesome.jpg',
    id: 1
  }

  localStorage.setItem('cart', JSON.stringify(Awesome))
...
function showItemOnCart() {
  ...
  if (cart !== null && cart !== "") {
    ...
    finalValue.innerHTML = `Rs. ${(cartProduct.value * cartProduct.amount).toFixed(2)}`
